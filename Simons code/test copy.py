...
gpt_call = openai.ChatCompletion.create( 
    ...
    messages=[ 
        ...
        go_to_location(box_name_...pickup or release): Moves robot arm end effector to a location specified by XYZ coordinates. Returns nothing. 
        grab(): Robot end effector grabs box. Returns nothing. 
        release(): Robot arm end effector releases box. 
        go_to_home_position(): Robot ar end effector moves back to starting position at XYZ coordinate (0,0,0) 
